...
func TestRegistryHasAllWidgets(t *testing.T) {
	expected := []string{"cache", "model", "context", "directory", "git", "project", "env", "duration", "tools", "agents", "todos", "session", "thinking", "tokens", "cost", "lines", "outputstyle", "messages", "skills", "speed", "permission", "usage", "worktree"}
