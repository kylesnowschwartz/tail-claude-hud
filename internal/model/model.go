...
// SkillInvocation records one skill invocation and when it happened.
// The timestamp lets the skills widget fade out stale entries.
...
type TranscriptData struct {
	...
	// (newest last), capped at 20. Names come from
	// <command-name>/skill</command-name> tags in user messages and from
	// assistant-side Skill tool_use blocks.
